//! Межи SSE-подій у стрімі до клієнта (B1 §1): клієнт отримує лише цілі події, а при обриву
//! upstream — одну подію `error` у форматі самого llama.cpp.

use bytes::Bytes;

/// Пропускає клієнту байти лише до останньої межи події (`\n\n` або `\r\n\r\n`); недописаний
...
/// Кінець (виключно) останньої межи подій у `b`: `\n\n` або `\r\n\r\n`.
